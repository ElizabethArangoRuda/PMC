#' Peat Spread Rate Index
#'
#' The PMCISI combines the ISI and PMC to provide a representation of
#' above-ground fire spread potential in peatland fuels.
#'
#' @param input_data A dataframe containing the columns 'Date', 'PMC' and 'ISI'.
#' @param year_to_plot The year to plot.
#'
#' @return A dataframe that retains the original columns and adds a column with the calculated PMC_ISI.
#' @export
#'
#' @examples
#' input_data <- data.frame(Date = as.Date(c("2014-01-01", "2014-01-02",
#' "2014-01-03")) , PMC = c(10.005600, 9.686799, 9.688504),
#' ISI = c(0.2, 0.1, 0.1))
